      ...
      >
        ...
        >
          ...
          <p className="md:w-full mt-2 text-gray-600 dark:text-gray-400 px-5 md:px-0 xl:px-0 mb-5">
            Fresh graduate with a degree in BS Information Technology, eager to
            apply my knowledge in real-world projects.
          </p>
        </motion.div>
        <motion.div
          variants={container}
        ...
        >
          {Educ.map((education, index) => (
            <motion.div
              ...
              key={index}
              variants={card}
              className="motion-smooth group max-w-xs md:max-w-175 xl:max-w-5xl w-full mx-auto grid grid-cols-1 my-2 
             bg-slate-50 rounded-xl p-5 dark:bg-zinc-800 
